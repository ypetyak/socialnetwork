...
const io = require("socket.io")(server, {origins: "localhost:8080"}); // we pass our wrapped server and configuartiona of our web socket. Don't forget to change this if you deploy to heroku you will need type there: "https://mysite.herokuapp.com:* "
